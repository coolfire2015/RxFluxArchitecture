 ...
 */
public abstract class BaseRxBindFragment<T extends ViewModel> extends RxFluxFragment<T> {
    @Inject
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return getDataBindingView(inflater, container, savedInstanceState);
    }
     ...
     * 生成DataBinding
     */
    protected abstract View getDataBindingView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState);
