...
import com.huyingbao.module.kotlin.ui.article.adapter.ArticleAdapter
...
constructor() : CommonRxFragment<ArticleStore>() {
    ...
    override fun afterCreate(savedInstanceState: Bundle) {
        setTitle(R.string.kotlin_label_article, true)
        initRecyclerView()
        initAdapter()
        showData()
    ...
    override fun onCreateOptionsMenu(menu: Menu?, inflater: MenuInflater?) {
        ...
        //菜单布局文件名同界面布局文件名
        inflater!!.inflate(R.menu.kotlin_fragment_article_list, menu)
    }
    ...
    private fun showData() {
        rxStore!!.articleLiveData.observe(this, { articleArrayList ->
            if (articleArrayList == null) return@getRxStore ().getArticleLiveData().observe
            //判断获取回来的数据是否是刷新的数据
