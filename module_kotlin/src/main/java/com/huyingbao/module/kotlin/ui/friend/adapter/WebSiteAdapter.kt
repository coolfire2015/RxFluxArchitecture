package com.huyingbao.module.kotlin.ui.friend.adapter
 ...
 */
class WebSiteAdapter(data: List<WebSite>?) : BaseQuickAdapter<WebSite, BaseViewHolder>(R.layout.kotlin_recycle_item, data) {
