...
abstract class FluxApp : Application() {
    ...
    private val lifecycleOwner: LifecycleOwner? by lazy {
        ...
        try {
            ...
            if (Log.isLoggable(FluxCallback.TAG, Log.WARN)) {
                Log.w(
                    FluxCallback.TAG, "Failed to find AppLifecycleOwner. You should include an"
    ...
    override fun onCreate() {
        ...
        registerActivityLifecycleCallbacks(FluxCallback)
        //分发ON_CREATE状态
        lifecycleOwner?.let {
