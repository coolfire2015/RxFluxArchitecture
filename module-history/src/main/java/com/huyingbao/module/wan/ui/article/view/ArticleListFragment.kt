...
import com.huyingbao.module.history.ui.article.adapter.ArticleAdapter
...
//        setTitle(R.string.app_label_history, false)
        initView()
    }
...
//    }
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        //Menu布局文件名同界面布局文件名
        inflater.inflate(R.menu.history_fragment_article_list, menu)
    }
